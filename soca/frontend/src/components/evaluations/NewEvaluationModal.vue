        ...
        <div>
          ...
          <div class="border border-gray-200 rounded-md max-h-40 overflow-y-auto">
            ...
            >
              ...
              >
                <svg v-if="selectedSubmissions.includes(submission.id)" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                </svg>
              </div>
              <span class="text-sm text-mine">{{ submission.name }}</span>
            </div>
            <div v-if="submissionsStore.submissions.length === 0" class="px-3 py-4 text-center text-sm text-taupe">
