<script setup lang="ts">
  ...
  const recentActivity = [
    {
      id: '1',
      title: 'Prompt edited: analyst_prompt.jinja',
      subtitle: 'quickstart-1',
      time: '2 hours ago',
    },
    {
      id: '2',
      title: 'New revision created: magical-crystal-51211a8b',
      subtitle: 'From quickstart-1',
      time: 'Yesterday',
    },
    {
      id: '3',
      title: 'Test run completed: bike-insights',
      subtitle: '1,234 tokens',
      time: '2 days ago',
    },
  ]
</script>
