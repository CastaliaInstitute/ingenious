...
18. **The Rebel Without a Corpus:** At the depositors' request, the Tijuana archive's courier has returned the sealed module to Ana in Chiapas. Q and Marisol check the receiving confirmation; Q does not carry it a second time. Ana invites him for a particular Spanish reply and discussion of Mateo's further training request. Both keepers attended the earlier session; one has changed jobs. Rain delays their departure. Q compares the removal request, talks with students, and writes with the Custodian. Ana's card carries an office contact for reviewing a proposed passage. The testimony stays with its keepers.
