...
9. **The Corpus Has No Tongue:** In Chiapas, Q works on Spanish deposit terms and an inventory while declining unreliable Tsotsil translation. Mateo's archive has a mixed register and human keepers, not a romantic absence of organization. Yadira describes both the danger of automatic public mirrors and the losses caused by failed retention. A radio outage is met with an approved concise bulletin, local-language checking, and people carrying notices. Q respects a child's privacy without finding the instruction intellectually difficult. Yadira's family requests restriction of a disputed published extract and access to the original. Q verifies a proposed sealed-deposit handover in Tijuana on the Mexican side, reviews risks and expenses with the others, and carries an encrypted module without possessing decryption keys.
10. **The Border Written in Air:** The handover is interrupted in Tijuana, without an intended US crossing. An international equipment record and a local provisional-custody instruction are brought to bear on Q at a freight-district inspection. He confirms his serial number while disputing ownership, keeps his companions' statements separate, and records an objection. A technician activates motor restraint before supporting his knee; Q falls and Chano intervenes. The papers and ledger remain in Tijuana. The sealed third-party module is inventoried separately and travels with Q into custody at Amealco. Elena, the intended receiver, retains the references and notifies the depositors. In transport, Omar's practical kindness helps Q without making the transfer voluntary.
...
Norma distinguishes Q's transport, the separately inventoried deposit, and the papers retained in Tijuana. Chano's dispatch knowledge helps them attach the actual destination and obtain a warehouse acknowledgment. Elena continues the local requests as they return to Amealco. A memorable sentence from an unrelated form is explicitly not evidence about Q. Ana's not-yet-introduced card no longer appears here.

### Interlude: The Record of the Return That Did Not Happen

Q arrives before his companions. The male Custodian attends to his body, records the intact deposit seal without opening it, and produces the original leave authorization. Q signs an arrival acknowledgment with an objection, not agreement with a voluntary-return narrative. His deposit report gives the actual unfinished task and next contact. Supervised movement is possible while unrestricted departure remains contested. He and the Custodian revisit the word freedom in their draft rather than magically leaving custody at the end of the scene.
